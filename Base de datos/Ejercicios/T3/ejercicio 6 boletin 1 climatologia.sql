...
select fecha, estación, temperatura_media, precipitacion_total::text
	case
		...
		else precipitacion_total = 0 or 'null'
			then 'NO HA LLOVIDO'
	end
from climatologia 
...
where hora_temperatura_maxima = '14:00'
			and fecha ilike '2019-03%' and upper(provincia = 'Asturias' or 'Cantabria');